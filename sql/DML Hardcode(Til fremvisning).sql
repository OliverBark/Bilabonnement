...
INSERT INTO pending_rentals(`cpr_nr`,`car_model`,`color`,`afleveringsforsikring`,`selvrisiko`,`location`,`monthly_fee`)
...
INSERT INTO Rentals (cpr_nr, car_model, color, afleveringsforsikring, selvrisiko, location, price_pr_km, start_date, end_date, monthly_fee, active)
...
INSERT INTO payments(amount, date, type, rental_id)
VALUES(2000, '2022-06-26', 'ONETIME', 1);

INSERT INTO payments(amount, date, type, rental_id)
VALUES(5000, '2021-05-05', 'ONETIME', 1);
