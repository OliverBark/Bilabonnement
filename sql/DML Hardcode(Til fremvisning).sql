...
INSERT INTO pending_rentals(`cpr_nr`,`model`,`color`,`afleveringsforsikring`,`selvrisiko`,`location`,`monthly_fee`)
...
INSERT INTO Rentals (cpr_nr, model, color, afleveringsforsikring, selvrisiko, location, price_pr_km, start_date, end_date, monthly_fee, active)
